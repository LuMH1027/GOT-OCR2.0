...
```Shell
deepspeed   /GOT_OCR_2_master/GOT/train/train_GOT.py \
 --deepspeed /GOT_OCR_2_master/zero_config/zero2.json    --model_name_or_path /GOT_weights/ \
...
**Note**:
1. Change the corresponding data information in [constant.py](https://github.com/Ucas-HaoranWei/GOT-OCR2.0/tree/main/GOT_OCR_2_master/GOT/utils).
2. Change line 37 in [conversation_dataset_qwen.py](https://github.com/Ucas-HaoranWei/GOT-OCR2.0/tree/main/GOT_OCR_2_master/GOT/data) to your data_name.
