...
from GOT.data import DataCollatorForSupervisedDataset, make_supervised_data_module, make_supervised_eval_data_module, make_supervised_train_data_module
...
def train():
    ...
    print(
        f"Number of Mapping Trainable Parameters: {sum(params_grad) / (1 << 20):.2f} M")
    ...
    # train_data = make_supervised_train_data_module(
    #     interleave=training_args.interleave,
    #     with_box=training_args.with_box,
    #     tokenizer=tokenizer,
    #     data_args=data_args
    # )
    # eval_data = make_supervised_eval_data_module(
    #     interleave=training_args.interleave,
    #     with_box=training_args.with_box,
    #     tokenizer=tokenizer,
    #     data_args=data_args
